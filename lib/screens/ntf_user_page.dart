      ...
      builder: (context, snapshot) {
        ...
        return ListView.builder(
          ...
          itemBuilder: (context, index) {
            ...
            try {
              notificationDate = DateFormat('dd/MM/yyyy').parse(notification["date"]);
    ...
    child: Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [const Color.fromARGB(255, 250, 240, 211)!, const Color.fromARGB(255, 255, 233, 154)!],
                  ...
                  onPressed: () {
                    showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          backgroundColor: const Color.fromARGB(255, 255, 250, 227),
                          title: const Text(
                            'Notification Details',
                            textAlign: TextAlign.center,
                            style: TextStyle(color: Colors.orange, fontWeight: FontWeight.bold), // Màu tiêu đề
                          ),
                          content: Column(
                            ...
                            children: [
                              Text(
                                'Date: $date',
                                style: const TextStyle(fontSize: 16, color: Colors.black), // Màu văn bản
                              ),
                              const SizedBox(height: 10),
                              Text(
                                'Details: $description',
                                textAlign: TextAlign.center, // Căn giữa cho văn bản
                          ...
                          actions: [
                            TextButton(
                              onPressed: () {
                                ...
                                SnackBar(
                                  ...
                                  backgroundColor: const Color.fromARGB(255, 59, 222, 5),
                            ...
                            TextButton(
                              ...
                              style: TextButton.styleFrom(
                                foregroundColor: Colors.orange, // Màu chữ nút đóng
                              ),
